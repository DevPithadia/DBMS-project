...
public class updateRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Enter Roll number to update record ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int cla=Integer.parseInt(jTextField5.getText());
        ...
        try{
            ...
            String query="update student SET First_Name='"+fname+"', Last_Name='"+lname+"', Class='"+cla+"', Section='"+section+"', Marks='"+marks+"' WHERE Roll_No='"+rollno+"';";
